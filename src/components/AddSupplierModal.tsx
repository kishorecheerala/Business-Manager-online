...
const AddSupplierModal: React.FC<AddSupplierModalProps> = ({ isOpen, onClose, onSave, existingSuppliers, initialData, inline = false }) => {
    ...
    return (
         ...
         >
            ...
            {/* Modal Container */}
            <div className="relative z-10 w-full sm:max-w-lg bg-white dark:bg-slate-800 rounded-t-2xl sm:rounded-xl shadow-2xl flex flex-col h-[85vh] sm:h-auto sm:max-h-[90vh] animate-slide-up-fade sm:animate-scale-in overflow-hidden border-t sm:border border-gray-200 dark:border-slate-700">
