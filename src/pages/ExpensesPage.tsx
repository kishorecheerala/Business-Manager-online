    ...
    return (
        <>
            {viewImageModal && (
                ...
                >
                    <div className="absolute inset-0 bg-black/80 animate-fade-in-fast" onClick={() => setViewImageModal(null)} />
                    <div className="relative z-10 max-w-full max-h-full">
                        ...
                        <img src={viewImageModal} alt="Receipt" className="max-w-full max-h-[90vh] rounded-lg animate-scale-in" onClick={(e) => e.stopPropagation()} />
                    </div>
                </div>
            )}
