            ...
            <Card className="relative z-10 w-full max-w-md p-0 overflow-hidden animate-scale-in border-none shadow-2xl bg-white dark:bg-slate-900">
                ...
                <div className="p-6 space-y-5">
                    ...
                    <div className="pt-4 space-y-3">
                        ...
                        <button
                            onClick={onClose}
                            className="w-full py-3 text-sm font-medium text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 transition-colors underline decoration-dotted underline-offset-4"
                        >
                            Skip Login
                        </button>
                    </div>
