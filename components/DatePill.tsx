...
const DatePill: React.FC<DatePillProps> = ({ className = '' }) => {
  return (
    <span className={`text-xs sm:text-sm font-bold bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-3 py-1.5 rounded-full shadow-md border border-indigo-500/30 flex items-center gap-2 whitespace-nowrap ${className}`}>
