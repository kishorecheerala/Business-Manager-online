                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-wrap gap-3">
                                        ...
                                        <Button onClick={onOpenAPIConfig} variant="secondary" className="h-auto py-2 text-xs">
                                            <Cloud size={14} className="mr-2" /> Change Project Code
                                        </Button>
                                        <Button onClick={() => window.open('https://console.cloud.google.com/apis/credentials', '_blank')} variant="secondary" className="h-auto py-2 text-xs">
                                            <Terminal size={14} className="mr-2" /> Open Google Console
                                        </Button>
